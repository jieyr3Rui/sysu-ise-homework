...
<body style="background:url(../images/login_bg.jpg); background-repeat:no-repeat; text-align:center; background-size: 100%;">
  ...
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder">课程作业列表</strong></div>
    ...
    where a.id=b.student_id and b.course_id=c.id and c.id=d.course_num and a.id=$yh and d.course_num='$course_id'";

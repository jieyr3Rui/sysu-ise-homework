...
<body style="background:url(../images/login_bg.jpg); background-repeat:no-repeat; text-align:center; background-size: 100%;">
    ...
    <div class="panel admin-panel">
      <div class="panel-head"><strong class="icon-reorder">学生作业</strong></div>
      <?php
      session_start();
      ...
      $sql = "select distinct a.*,h.*
    	from student a,homework h,course c,project p,teach_list tl
    	where a.id=h.id and h.project_num=p.project_num and p.course_num=tl.course_id and tl.teacher_id=$tno";
      ...
      <table class="table table-hover text-center">
        ...
        ?>
          ...
          <tr>
            ...
            <td align="center"><a href="teacher_student_mark2.php?sno=<?php echo $row['id'] ?>&project_num=<?php echo $row['project_num'] ?>"><button class="button_new button_green">评分</button></a>

...
if (isset($_POST['up'])) {
  ...
  if ($rs == true) {
    ?>
    <td align="center"><a href="teacher_student_alllist.php"><button class="button bg-main icon-check-square-o">评分成功，返回</button></a>
    <?php
  } else {
    ?>
    <td align="center"><a href="teacher_student_alllist.php"><button class="button bg-main icon-check-square-o">评分失败，返回</button></a>
    <?php
  }
}
